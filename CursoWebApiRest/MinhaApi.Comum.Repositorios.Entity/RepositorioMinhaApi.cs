...
namespace MinhaApi.Comum.Repositorios.Entity
{
    public abstract class RepositorioMinhaApi<TDominio, TChave> : IRepositorioMinhaApi<TDominio, TChave>
        where TDominio : class
    {
        protected DbContext _context;

        public RepositorioMinhaApi(DbContext context)
        {
            _context = context;
        }
